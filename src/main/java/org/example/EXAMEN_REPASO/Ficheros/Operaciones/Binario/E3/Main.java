...
public class Main {
        ...
        try {
            ...
            */
            ...
            for(int cont=0;cont<separados.length;cont++){
                if(cont%5==0 && cont!=0 && cont!=5){   //5 = numero atributos  el !=0 porque da error si no y cont!=5 porque la primera vez suele venir los atributos tal cual sin valor
    ...
    //TE GUARDA EN EL DAT LOS DATOS DE LA ARRAY
